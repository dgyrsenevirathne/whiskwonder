<%-- 
    ...
    Created on : May 29, 2023, 10:43:16 AM
    Author     : szxcr
--%>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__option">
            <ul>
                <li><a href="adminsign.html"> </a> <span class="arrow_carrot-down"></span></li>
            </ul>
        </div>
    </div>
    <!-- Offcanvas Menu End -->
                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="shoping-cart.jsp">Checkout</a>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        ...
                        <h4>Dozen Cupcakes</h4>
                        <h5>RS 260.40</h5>
                        <p>A dozen cupcakes refers to a collection of twelve delicious and visually appealing individual-sized cakes. These cupcakes are baked in small, paper or aluminum cup-like containers, which give them their signature shape and make them easy to handle.
                           Each cupcake is made from a soft and flavorful cake batter that can be customized with various flavors, ranging from classic vanilla and chocolate to more adventurous options like lemon, coconut, or caramel. The batter is carefully portioned into the cupcake liners, ensuring that each cake is uniform in size.</p>
                        <ul>
                            <li>Category: <span>Cupcake</span></li>
                        </ul>
                        <div class="product__details__option">
                            ...
                            <a href="shoping-cart.jsp" class="primary-btn">Proceed to checkout</a>
                            <a href="shoping-cart.jsp" class="heart__btn"><span class="icon_heart_alt"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__item__price">RS 300.00</div>
                                <div class="cart_add">
                                    <a href="#">Proceed to checkout</a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="product__item">
                            ...
                            <div class="product__item__text">
                                ...
                                <div class="product__item__price">RS 140.00</div>
                                <div class="cart_add">
                                    <a href="#">Proceed to checkout</a>
                                </div>
                            </div>
